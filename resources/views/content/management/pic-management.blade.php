...
@section('title', 'Person In Charge Management')
...
<script>
  ...
  $(function () {
    ...
    var dt_user_table = $('.datatables-records'),
      select2 = $('.select2'),
      userView ='#',
      offCanvasPICForm = $('#offcanvasAddPIC');
      ...
      var dt_user = dt_user_table.DataTable({
        ...
        columnDefs: [
          ...
          },
          {
            ...
            targets: 3,
            render: function (data, type, full, meta) {
              var $address = full['email'];

              return '<span class="user-address">' + $address + '</span>';
            }
          },
          {
            // Rate
            ...
            render: function (data, type, full, meta) {
              ...
              return '<span class="user-currency">' + $contact + '</span>';
            }
          },
          {
            // Company
            targets: 5,
            render: function (data, type, full, meta) {
              var $currency = full['company_name'];
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              return (
                ...
                `<button class="btn btn-sm btn-icon edit-record" data-id="${full['id']}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddPIC"><i class="ti ti-edit"></i></button>` +
        ...
        buttons: [
          ...
          {
            text: '<i class="ti ti-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add New PIC</span>',
            className: 'add-new btn btn-primary',
            attr: {
              'data-bs-toggle': 'offcanvas',
              'data-bs-target': '#offcanvasAddPIC'
            }
          }
        ],
    ...
    $(document).on('click', '.edit-record', function () {
      ...
      $('#offcanvasAddPICLabel').html('Edit PIC');

      // get data
      $.get(`${baseUrl}pic-list\/${_id}\/edit`, function (data) {
        $('#_id').val(data.id);
        $('#_name').val(data.name);
        $('#_contact').val(data.contact);
        $('#_company').val(data.company_id).trigger("change");
        $('#_email').val(data.email).trigger("change");
      });
    });
    ...
    $('.add-new').on('click', function () {
      ...
      $('#offcanvasAddPICLabel').html('Add PIC');
      $("#_company").select2("val", "");
    });
...
<div class="card">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddPIC" aria-labelledby="offcanvasAddPICLabel">
    <div class="offcanvas-header">
      <h5 id="offcanvasAddPICLabel" class="offcanvas-title">Add</h5>
    ...
    <div class="offcanvas-body mx-0 flex-grow-0">
      <form class="add-new-user pt-0" id="addPICRecordForm">
        ...
        <div class="mb-3">
          <label for="currency" class="form-label">Company</label>
