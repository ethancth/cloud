...
<script>
  ...
  $(function () {
    ...
    if (dt_user_table.length) {
      var dt_user = dt_user_table.DataTable({
        ...
        buttons: [
          ...
          {
            text: '<i class="ti ti-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add New Position</span>',
    ...
    $(document).on('click', '.delete-record', function () {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          Swal.fire({
            title: 'Cancelled',
            text: 'The Position is not deleted!',
            icon: 'error',
            customClass: {
              confirmButton: 'btn btn-success'
            }
    ...
    $(document).on('click', '.edit-record', function () {
      ...
      $('#offcanvasAddUserLabel').html('Edit position');

      // get data
      $.get(`${baseUrl}position-list\/${_id}\/edit`, function (data) {
        $('#_id').val(data.id);
        $('#_name').val(data.name);
      });
    });
    ...
    $('.add-new').on('click', function () {
      ...
      $('#offcanvasAddUserLabel').html('Add position');
    });
      ...
      $.ajax({
        ...
        success: function (status) {
          ...
          Swal.fire({
            ...
            text: `Position ${status} Successfully.`,
            customClass: {
              confirmButton: 'btn btn-success'
            }
          });
        ...
        error: function (err) {
          ...
          Swal.fire({
            ...
            text: 'Position should be unique.',
            icon: 'error',
            customClass: {
              confirmButton: 'btn btn-success'
            }
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
    ...
    <div class="offcanvas-body mx-0 flex-grow-0">
      <form class="add-new-user pt-0" id="addNewRecordForm">
        ...
        <div class="mb-3">
          <label class="form-label" for="_name">position Name</label>
