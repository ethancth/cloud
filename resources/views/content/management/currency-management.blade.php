...
<script>
  ...
  $(function () {
        ...
        columnDefs: [
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              ...
              return '<span class="record-rate">' + $rate + '</span>';
            }
          },
          {
            // Rate
            ...
            render: function (data, type, full, meta) {
              ...
              return '<span class="record-time">' + $time + '</span>';
            }
          },
          {
            // Actions
            ...
            render: function (data, type, full, meta) {
              return (
                ...
                `<button class="btn btn-sm btn-icon edit-record" data-id="${full['id']}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddRecord"><i class="ti ti-edit"></i></button>` +
    ...
    $(document).on('click', '.edit-record', function () {
      ...
      $('#offcanvasAddRecordLabel').html('Edit currency');

      // get data
      $.get(`${baseUrl}currency-list\/${_id}\/edit`, function (data) {
        $('#_id').val(data.id);
    ...
    $('.add-new').on('click', function () {
      ...
      $('#offcanvasAddRecordLabel').html('Add Currency');
      ...
      $.ajax({
        ...
        error: function (err) {
          ...
          Swal.fire({
            ...
            text: 'Currency should be unique.',
            icon: 'error',
            customClass: {
              confirmButton: 'btn btn-success'
            }
...
<div class="card">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddRecord" aria-labelledby="offcanvasAddRecordLabel">
    <div class="offcanvas-header">
      <h5 id="offcanvasAddRecordLabel" class="offcanvas-title">Add</h5>
    ...
    <div class="offcanvas-body mx-0 flex-grow-0">
      <form class="add-new-user pt-0" id="addNewRecordForm">
        ...
        <div class="mb-3">
          <label class="form-label" for="_name">Currency Name</label>
          <input type="text" class="form-control" id="_name" placeholder="currency Display Name" name="name" aria-label="" />
        </div>

        <div class="mb-3">
          <label class="form-label" for="_name">Rate</label>
          <div class="input-group">
{{--            <div class="input-group-text">--}}
{{--              <input class="form-check-input mt-0" type="checkbox" value="" aria-label="Checkbox for following text input">--}}
{{--            </div>--}}
            <input type="number" step="0.01" id="rate" name="rate" class="form-control" aria-label="Text input with checkbox" >
          </div>
