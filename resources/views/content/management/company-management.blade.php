...
<script>
  ...
  $(function () {
    ...
    var dt_user_table = $('.datatables-records'),
      select2 = $('.select2'),
      userView1 =`${baseUrl}company/`,
      userView2 ='/address-book',
    ...
    if (dt_user_table.length) {
      var dt_user = dt_user_table.DataTable({
          ...
          },
          {
            ...
            render: function (data, type, full, meta) {
              ...
              return (
                ...
                `<button class="btn btn-sm btn-icon edit-record" data-id="${full['id']}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddCompany"><i class="ti ti-edit"></i></button>` +
                ...
                userView1 +$id+userView2+
                '"><i class="ti ti-address-book"></i></a>' +
                '</div>'
              );
            }
          }
        ...
        buttons: [
          ...
          {
            text: '<i class="ti ti-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add New Company</span>',
    ...
    $(document).on('click', '.edit-record', function () {
      ...
      // get data
      $.get(`${baseUrl}company-list\/${_id}\/edit`, function (data) {
        $('#_id').val(data.id);
        $('#_name').val(data.name);
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddCompany" aria-labelledby="offcanvasAddCompanyLabel">
    ...
    <div class="offcanvas-body mx-0 flex-grow-0">
      <form class="add-new-user pt-0" id="addNewCompanyForm">
        ...
        <div class="mb-3">
          <label class="form-label" for="_name">Billing Address</label>
          <textarea class="form-control" placeholder="Billing Address"  id="billing_address" name="billing_address"  ></textarea>
        </div>

        <div class="mb-3">
          <label class="form-label" for="_name">Delivery Address</label>
