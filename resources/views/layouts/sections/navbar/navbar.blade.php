              ...
              <div class="dropdown-shortcuts-list scrollable-container">
                <div class="row row-bordered overflow-visible g-0">
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <a href="{{url('app/opf/create')}}" class="stretched-link">OPF</a>
                    <small class="text-muted mb-0">Create New OPF</small>
                  </div>
                </div>
                <div class="row row-bordered overflow-visible g-0">
                  <div class="dropdown-shortcuts-item col">
                  ...
                  <div class="dropdown-shortcuts-item col">
                    ...
                    <a href="{{url('company-management')}}" class="stretched-link">Customer Management</a>
                    <small class="text-muted mb-0">Manage Customer</small>
                  </div>
                </div>
              </div>
            </div>
                ...
                <a class="dropdown-item" href="{{ Route::has('profile.show') ? route('profile.show') : url('pages/profile-user') }}">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <small class="text-muted"> {{ Auth::user()->position_name }}</small>
                    </div>
                  </div>
                </a>
              </li>
